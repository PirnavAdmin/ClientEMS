...
export const API = {
 ...
 USER_PERMISSION: {
  ...
  EXPERIENCE_LETTER: {
    ...
    GET_ALL: "/ExperienceLetter",

    PREVIEW: (id) => `/ExperienceLetter/preview/${id}`,

    SEND: "/ExperienceLetter/send",

    DOWNLOAD: (id) => `/ExperienceLetter/download/${id}`,
...
export const API_ENDPOINTS = {
  ...
  experienceLetters: {
    ...
    send: API.EXPERIENCE_LETTER.SEND,
