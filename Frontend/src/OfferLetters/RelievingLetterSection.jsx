...
function RelievingLetterSection() {
  const letterType = "relieving";
  ...
  const [sendRelievingLetterTarget, setSendRelievingLetterTarget] = useState(null);
  const [sendRelievingLetterSubject, setSendRelievingLetterSubject] = useState("");
  ...
  const [sendingRelievingLetterId, setSendingRelievingLetterId] = useState(null);
  const [deleteRelievingLetterTarget, setDeleteRelievingLetterTarget] = useState(null);
  const [deletingRelievingLetterId, setDeletingRelievingLetterId] = useState(null);
...
HR Team`,
  ...
  }, [letterType, fetchEmployees, loadRelievingLetters]);
  ...
  const validateForm = () => {
    ...
    if (!formData.candidatePhone.trim())
      newErrors.candidatePhone = "Phone is required";
    ...
    if (!formData.probationPeriod.trim())
      newErrors.probationPeriod = "Probation Period is required";

    if (!formData.probationNoticePeriod.trim())
      newErrors.probationNoticePeriod = "Probation Notice Period is required";

    if (!formData.postConfirmationNoticePeriod.trim())
      newErrors.postConfirmationNoticePeriod = "Post Confirmation Notice Period is required";

    if (!formData.acceptanceDeadline)
      newErrors.acceptanceDeadline = "Acceptance Deadline is required";
    ...
    if (!formData.authorizedSignatoryDesignation.trim())
      newErrors.authorizedSignatoryDesignation =
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        probationPeriod: formData.probationPeriod.trim(),
        probationNoticePeriod: formData.probationNoticePeriod.trim(),
        postConfirmationNoticePeriod:
          formData.postConfirmationNoticePeriod.trim(),
        acceptanceDeadline: formData.acceptanceDeadline,
        authorizedSignatory:
          formData.authorizedSignatory.trim(),
        authorizedSignatoryDesignation:
          formData.authorizedSignatoryDesignation.trim(),
  ...
  const validateRelievingForm = () => {
    ...
    if (!relievingForm.relievingDate) {
      errors.relievingDate = "Relieving Date is required";
    }

    if (!relievingForm.noticePeriodStatus) {
      errors.noticePeriodStatus =
        "Notice Period Status is required";
    }

    if (!relievingForm.fullFinalSettlement.trim()) {
      errors.fullFinalSettlement =
        "Full & Final Settlement is required";
    }

    if (!relievingForm.authorizedSignatory.trim()) {
      errors.authorizedSignatory =
        "Authorized Signatory is required";
    }

    if (!relievingForm.authorizedSignatoryDesignation.trim()) {
      errors.authorizedSignatoryDesignation =
        "Authorized Signatory Designation is required";
    }

    setRelievingErrors(errors);
  ...
  const handleGenerateRelievingLetter = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        title: relievingForm.title,
        designation: relievingForm.designation,
        resignationDate: relievingForm.resignationDate,
        relievingDate: relievingForm.relievingDate,
        noticePeriodStatus: relievingForm.noticePeriodStatus,
        fullFinalSettlement: relievingForm.fullFinalSettlement,
        authorizedSignatory: relievingForm.authorizedSignatory,
        authorizedSignatoryDesignation:
          relievingForm.authorizedSignatoryDesignation,
      };
...
<div className="offer-card">
            ...
            <div className="form-grid">
              ...
              <div className="form-group">
                ...
                <select
                  value={relievingForm.noticePeriodStatus}
                  onChange={(e) =>
                    setRelievingForm(prev => ({
                      ...prev,
                      noticePeriodStatus: e.target.value
                    }))
                  }
                >
                ...
                {relievingErrors.noticePeriodStatus && (
                  <p className="field-error">
                    {relievingErrors.noticePeriodStatus}
                  </p>
                )}
              ...
              <div className="form-group">
                ...
                <input
                  type="text"
                  value={relievingForm.fullFinalSettlement}
                  onChange={(e) =>
                    setRelievingForm(prev => ({
                      ...prev,
                      fullFinalSettlement: e.target.value
                    }))
                  }
                  placeholder="Enter settlement status"
                />
                {relievingErrors.fullFinalSettlement && (
                  <p className="field-error">
                    {relievingErrors.fullFinalSettlement}
                  </p>
                )}
              ...
              <div className="form-group">
                ...
                <input
                  type="text"
                  value={relievingForm.authorizedSignatory}
                  onChange={(e) =>
                    setRelievingForm(prev => ({
                      ...prev,
                ...
                />
                {relievingErrors.authorizedSignatory && (
                  <p className="field-error">
                    {relievingErrors.authorizedSignatory}
                  </p>
                )}
              ...
              <div className="form-group">
                ...
                <input
                  type="text"
                  value={relievingForm.authorizedSignatoryDesignation}
                  onChange={(e) =>
                    setRelievingForm(prev => ({
                      ...prev,
                ...
                />
                {relievingErrors.authorizedSignatoryDesignation && (
                  <p className="field-error">
                    {relievingErrors.authorizedSignatoryDesignation}
                  </p>
                )}
...
export default RelievingLetterSection;
