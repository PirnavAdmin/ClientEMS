...
<div className="offer-card">
            ...
            <div className="form-grid offer-letter-form-grid">
              ...
              <div className="form-group">
                <label>Probation Notice Period</label>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Enter probation notice period"
                />

                {errors.probationNoticePeriod && (
                  <p className="field-error">
                    {errors.probationNoticePeriod}
                  </p>
                )}
              ...
              {/* Post Confirmation Notice Period */}
              <div className="form-group">
                <label>Post Confirmation Notice Period</label>

                <input
                  type="text"
                  name="postConfirmationNoticePeriod"
                  value={formData.postConfirmationNoticePeriod}
                  onChange={handleChange}
                  placeholder="Enter post confirmation notice period"
                />

                {errors.postConfirmationNoticePeriod && (
                  <p className="field-error">
                    {errors.postConfirmationNoticePeriod}
                  </p>
                )}
              ...
              <div className="form-group">
                <label>
                  <FaCalendarAlt /> Acceptance Deadline
                </label>
