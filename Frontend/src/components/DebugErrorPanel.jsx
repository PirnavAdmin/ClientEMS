...
const outerStyle = {
  ...
  placeItems: "center",
  background:
    "radial-gradient(circle at top left, rgba(239, 68, 68, 0.12), transparent 25%), radial-gradient(circle at bottom right, rgba(22, 121, 196, 0.12), transparent 28%), linear-gradient(180deg, rgba(255, 255, 255, 0.96), rgba(248, 250, 252, 0.94))",
};
...
const buttonStyle = {
  ...
  cursor: "pointer",
  background: "linear-gradient(135deg, var(--theme-primary, #1679C4), var(--theme-secondary, #0E5EA8))",
