...
namespace EmployeeManagementSystem.Services
{
  ...
  if (employee == null)
    ...
    email,
    "Welcome to Honeywell HRMS – Your Employee Account Has Been Created",
    $@"
<!DOCTYPE html>
<html>
<head>
...
<body style='font-family: Segoe UI, Arial, sans-serif;
    ...
    <div style='max-width: 650px;
        ...
        <h2 style='margin-top: 0;'>
            Welcome to Honeywell HRMS
        </h2>

        <p>Dear <strong>{name}</strong>,</p>

        <p>
            Welcome to <strong>Honeywell</strong>.
            Your employee account has been successfully created
            in the Honeywell Human Resource Management System (HRMS).
        </p>
        ...
        <p style='font-size: 12px;
                  color: #777777;'>
            This is an automated email generated by Honeywell HRMS.
